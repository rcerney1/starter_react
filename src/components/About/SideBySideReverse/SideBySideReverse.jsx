            ...
            <div className="cs-container scroll-fade delay-2">
                <div className="cs-image-group scroll-fade delay-3">
                    <picture className="cs-picture cs-picture1">
                        <source media="(max-width: 600px)" srcSet="/images/about/sbs-painter-2-m.webp" />
                        <source media="(min-width: 601px)" srcSet="/images/about/sbs-painter-2-d.webp" />
                        <img loading="lazy" decoding="async" src="/images/about/sbs-painter-2-d.webp" alt="appliance" width="323" height="447" />
                    </picture>
                    <picture className="cs-picture cs-picture2">
                        <source media="(max-width: 600px)" srcSet="/images/about/sbs-painter-3-m.webp" />
                        <source media="(min-width: 601px)" srcSet="/images/about/sbs-painter-3-d.webp" />
                        <img loading="lazy" decoding="async" src="/images/about/sbs-painter-3-d.webp" alt="appliance" width="305" height="441" />
                    </picture>
